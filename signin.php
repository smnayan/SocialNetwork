<html>
<head>
<title> Login to social network</title>
  <meta charset="utf-8">
				...
				<div class="l-part">
				    <form action="" method="POST">
						...
						<div class="overlap-text">
						   ...
						   title="Reset Password" href="forgot_password.php">Forgot password?</a>
						...
						<center><button id="signin" class="btn btn-info btn-lg" name="login">
						Login</button></center>
						<?php
						  include("login.php"); 
						?>
