<?php
	...
	if(isset($_POST['sign_up'])){
		...
		user_email , user_country , user_gender , user_birthday , user_image , user_cover , user_reg_date ,
		status , post ,recovery_account) 
		values ('$first_name' , '$last_name' , '$username' , 'Hello! This is my degault status' , ' ...' , '$pass' ,
		'$email' , '$country', '$gender' , '$birthday' , '$profile_pic' , 'default_cover.jpg', NOW(),
		'$status' , '$post' , 'Iwanttoputadingintheuniverse')";	
